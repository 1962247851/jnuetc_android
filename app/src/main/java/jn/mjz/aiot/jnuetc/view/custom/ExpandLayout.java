...
public class ExpandLayout extends RelativeLayout {
    ...
    private void animateToggle(long animationDuration) {
        ...
        heightAnimation.setDuration(animationDuration / 4 * 3);
        heightAnimation.setStartDelay(animationDuration / 4);
    ...
    public void reSetViewDimensions() {
        layoutView.post(() -> viewHeight = layoutView.getMeasuredHeight());
    }
